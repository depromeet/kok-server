...
public class PublicTransportationComplexClient {
    ...
    public PublicTransportationComplexClient(TmapComplexClientProperties properties,
    ...
    public TmapComplexPublicTransportationResponse callComplexPublicTransportRoute(Long stationId,
