...
import com.kok.kokapi.public_transportation.adapter.in.dto.request.RouteRequest;
...
public class PublicTransportationController {
    ...
    public ResponseEntity<ApiResponseDto<TmapPublicTransportationParsedResponse>> getPublicTransportation(
        @PathVariable Long stationId, @RequestBody RouteRequest routeRequest) {
        try {
            TmapPublicTransportationParsedResponse publicTransportation = objectMapper.readValue(
                retrievePublicTransportationUsecase.retrievePublicTransportation(stationId,
                    routeRequest.roomId(), routeRequest.memberId())
    ...
    public ResponseEntity<ApiResponseDto<TmapComplexPublicTransportationParsedResponse>> getComplexPublicTransportation(
        @PathVariable Long stationId, @RequestBody RouteRequest routeRequest) {
        try {
            TmapComplexPublicTransportationParsedResponse publicTransportation = objectMapper.readValue(
                retrievePublicTransportationUsecase.retrieveComplexPublicTransportation(stationId,
                    routeRequest.roomId(), routeRequest.memberId())
