...
import com.kok.kokapi.room.adapter.in.dto.response.ParticipantResponse;
...
public class RoomController extends BaseController {
    ...
    public ResponseEntity<ApiResponseDto<List<ParticipantResponse>>> getParticipants(@PathVariable String roomId) {
        Room room = getRoomUseCase.getRoomById(roomId);
        ...
        var response = profiles.stream()
                .map(profile -> new ParticipantResponse(
                        profile,
    ...
    public ResponseEntity<ApiResponseDto<String>> joinRoom(@PathVariable String roomId,
        ...
        getRoomUseCase.getRoomById(roomId);
        joinRoomUseCase.addParticipant(roomId, request.profile());
